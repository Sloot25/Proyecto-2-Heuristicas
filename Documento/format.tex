...
\usepackage{listings} % Asegúrate de que esté cargado

\lstset{
  basicstyle=\footnotesize\ttfamily, % <-- LÍNEA CLAVE: Usa fuente pequeña
  breaklines=true,
  ...
  numbers=left,
    ...
    keywordstyle=\color{blue},   % Opcional: colores
